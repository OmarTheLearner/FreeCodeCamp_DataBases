...
--
-- Name: games fk_1; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_1 FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);


--
-- Name: games fk_2; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_2 FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
